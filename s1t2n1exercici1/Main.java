...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Codi necessari per a generar i capturar una excepció de tipus index out of bounds exception
		try {
				System.out.println(Venda.getColleccio().get(Venda.getColleccio().size() + 1));
		    } catch (Exception e) {
		      System.out.println("Excepció IndexOutOfBoundsException");
		    }
	}
}